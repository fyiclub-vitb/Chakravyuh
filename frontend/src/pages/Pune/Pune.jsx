  ...
  const handleSubmit = async (e) => {
    ...
    if (enteredCode === correctPasscode) {
      ...
      try {
        ...
        if (response.data.success) setTimeout(() => navigate('/chennai/backstory'), 1500)
      } catch (error) {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-black">
      <div className="w-4/5 h-full">
        <iframe src="/game/index.html" className="w-full h-full border-none" title="Pune Game" />
      </div>
